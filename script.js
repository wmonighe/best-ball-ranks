const csvUrl =
  'https://docs.google.com/spreadsheets/d/1rNouBdE-HbWafu-shO_5JLPSrLhr-xuGpXYfyOI-2oY/export?format=csv&gid=148406078';
      ...
      if (rows.length > 0) {
        ...
        for (let i = 1; i < rows.length; i++) {
          ...
          if (
            ...
            const name = cells[playerIdx].textContent.trim();
...
loadData();
=======
const csvUrl = 'https://docs.google.com/spreadsheets/d/1rNouBdE-HbWafu-shO_5JLPSrLhr-xuGpXYfyOI-2oY/export?format=csv&gid=148406078';
